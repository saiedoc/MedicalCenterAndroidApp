...
public class PatientDoctorListRecyclerAdapter extends RecyclerView.Adapter<PatientDoctorListRecyclerAdapter.DoctorViewHolder> {
    ...
    public PatientDoctorListRecyclerAdapter(Context ct , List<Doctor> doctors, RecyclerViewClickListener ItemListener){
